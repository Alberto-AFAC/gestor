                        ...
                        <div class="box">
                            ...
                            <section class="content">
                                ...
                                <div class="box-body">
                                    ...
                                    <!-- <table style="width: 100%;" id="data-table-inspectores"
                    ...
                    <div class="modal-dialog width" role="document" style="/*margin-top: 7em;*/">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" onclick="location.href='inspecion.php'" class="close"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-5">
                                                <label>NOMBRE</label>
                                                <input type="text" class="form-control" id="spcialid_nombre"
                                                    name="spcialidad_nombre" disabled="">
                                            </div>
...
$resultado = mysqli_query($conexion, $query);
  ...
  ?>
    ...
    ["<?php echo  $data['gstNmpld']?>", "<?php echo  $data['gstNombr']?>", "<?php echo $data['gstApell']?>",
        "<?php echo $data['gstCatgr']?>", "<?php  if($antiguedad <=30){
        echo "<span style='font-weight: bold; height: 50px; color: green;'>Nuevo ingreso</span>";
      }else {
        echo "<span style='font-weight: bold; height: 50px; color: #3C8DBC;'>Personal antiguo</span>";
      } ?>", "<?php
