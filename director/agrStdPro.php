          ...
          <div class="modal-dialog">
              <div class="modal-content">
                  <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">&times;</span></button>
                      <h4 class="modal-title">BAJA DE PERSONAL</h4>
                  </div>
                  <div class="modal-body">
                    <input type="hidden" name="bajaIdper" id="bajaIdper"> 
                    <!-- <input type="text" name="documen" id="documen"> -->
                      <div class="form-group">
                          <div class="col-sm-12">
                           <label class="label2" id="titledoc" for=""></label>
                          ...
                          <br>
                          <div class="col-sm-5">
                              <button type="button" id="baja" class="btn btn-primary altaboton" style="font-size:14px; width:110px; height:35px" onclick="usuBaja()">ACEPTAR</button>
                          </div>
                          <b>
                              <p class="alert alert-warning text-center padding error" id="danger11">Error
    ...
    <div class="modal fade" id="modal-doc">
          <div class="col-xs-12 .col-md-0"  tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
            ...
            <div class="form-group">
              <div class="col-sm-12">              
              <label class="label2"  for=""></label>
              <input type="hidden" name="ojtNemple" id="ojtNemple">
