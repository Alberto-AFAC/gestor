                            ...
                            <form id="Dtall" class="form-horizontal" action="" method="POST">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        ...
                                        <select style="width: 100%" class="selectpicker inputalta" name="gstAreIDasig"
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        ...
                                        <select style="width: 100%" class="selectpicker inputalta" id="gstIDara"
                                            name="gstIDara" type="text" data-live-search="true" disabled="">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        ...
                                        <select type="text" class="form-control inputalta" id="gssubdireccion"
                                            name="gssubdireccion">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-0 col-sm-12">
                                        ...
                                        <select style="width: 100%" class="form-control" class="selectpicker inputalta"
                                            name="" id="" type="text" data-live-search="true">
...
$resultado = mysqli_query($conexion, $query);
    ...
    ["<?php echo  $data['gstNmpld'];?>", "<?php echo $data['gstNombr']?>", "<?php echo $data['gstApell']?>",
        "<?php echo $data['gstCatgr']?>", "<?php echo $data['gstCargo']?>",
