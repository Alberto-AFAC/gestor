...
require_once "../../conexion/conexion.php";
	...
	?>
	<select  id="gstIDuniAct" class="form-control" class="selectpicker" name="gstIDuniAct" type="text" data-live-search="true" style="width: 100%" >
...
<?php   }else{   ?>
	...
	<input id="gstIDuniAct" class="form-control" class="selectpicker" name="gstIDuniAct" type="text" data-live-search="true" style="width: 100%" >
			<!-- <option value="0">AEROPUERTOS </option>  -->
			<!-- </select> -->
