...
html += '<tr><th scope="row">' + n + ')</th><td>' +obj.data[H].ojt_principal+ '</td><td> <a href="#" data-toggle="modal" data-target="#detalleSub3" onclick="idsubTa('+"'" + datos + "'"+')">'+obj.data[H].ojt+'</a></td></tr>'; 
}
