            ...
            if (obj.data[i].id_curso == idcurso) {
                ...
                if (obj.data[i].modalidad == 'PRESENCIAL') {
                   ...
                   //$("#link").html(obj.data[i].link);
                    if (obj.data[i].link == 'N/A' || obj.data[i].link == '0' || obj.data[i].link == '' || obj.data[i].link == 'NA') {
                        $("#link").html('N/A');
                    } else {
                        $("#link").html(obj.data[i].link);
                        document.getElementById("link").setAttribute("href", obj.data[i].link);
                    }
                    $("#contracur").html(obj.data[i].contracur);
                    
                    if (obj.data[i].classroom == 'N/A' || obj.data[i].classroom == '0' || obj.data[i].classroom == '' || obj.data[i].classroom == 'NA') {
                        $("#classroom").html('N/A');
                    } else {
                        $("#classroom").html(obj.data[i].classroom);
                        document.getElementById("classroom").setAttribute("href", obj.data[i].classroom);
                    }
                    //$("#classroom").html(obj.data[i].classroom);
            ...
            if (obj.data[i].id_curso == idcurso) {
                ...
                if (obj.data[i].modalidad == 'PRESENCIAL') {
                    ...
                    if (obj.data[i].link == 'N/A' || obj.data[i].link == '0' || obj.data[i].link == '' || obj.data[i].link == 'NA') {
                        ...
                        $("#link1").html(obj.data[i].link);
                        document.getElementById("link1").setAttribute("href", obj.data[i].link);
                    }
                    ...
                    if (obj.data[i].classroom == 'N/A' || obj.data[i].classroom == '0' || obj.data[i].classroom == '' || obj.data[i].classroom == 'NA') {
                        ...
                        document.getElementById("classroom1").setAttribute("href", obj.data[i].classroom);
                    }
...
//alert(idpersona1)
            ...
            for (R = 0; R < res.length; R++) { //RASTREAR EL ID DE LA PERSONA
                if (obj.data[R].gstIdper == idpersona1) {
                    ...
                    $("#rusprins").val(obj.data[R].gstRusp);
                    $("#rnetprins").val(obj.data[R].sgtCrhnt);
                }
            }
...
function actContr() {
    ...
    var frm=$("#frmActuliar").serialize();
            //alert(frm);
            $.ajax({
            url: '../php/actContra.php',
            type:'POST',
            data:frm+"&opcion=actCont"
