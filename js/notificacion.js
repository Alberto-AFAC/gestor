    ...
    $.ajax({
        ...
        $.ajax({
            ...
            if (obj.data[0].VENCER == 0) {
                ...
                document.getElementById("notvencer").innerHTML = "" + '<a href="porvencer2.php"><li class="fa fa-warning text-yellow"></li> Tienes ' + obj.data[0].VENCER + ' curso por vencer.</a>';
            } else {
                document.getElementById("notvencer").innerHTML = "" + '<a href="porvencer2.php"><li class="fa fa-warning text-yellow"></li> Tienes ' + obj.data[0].VENCER + ' cursos por vencer.</a>';
            }
            if (obj.data[0].VENCIDO == 0) {
                $("#ocuvncd").hide();
            } else if (obj.data[0].VENCIDO == 1) {
                document.getElementById("notvencdo").innerHTML = "" + '<a href="vencidos2.php"><li class="fa fa-warning text-yellow"></li> Tienes ' + obj.data[0].VENCIDO + ' curso vencido.</a>';
            } else {
                document.getElementById("notvencdo").innerHTML = "" + '<a href="vencidos2.php"><li class="fa fa-warning text-yellow"></li> Tienes ' + obj.data[0].VENCIDO + ' cursos vencidos.</a>';
            }
