...
var preg31 = $('input[name=preg28]:checked').val(); //-
var preg32 = $('input[name=pregPEN31]:checked').val(); //-
//PREGUNTA ABIERTA 
...
datos = 'idcursoen=' + idcursoen + '&preg1=' + preg1 + '&preg2=' + preg2 + '&preg3=' + preg3 + '&preg4=' + preg4 + '&preg5=' + preg5 + '&preg6=' + preg6 + '&preg7=' + preg7 + '&preg8=' + preg8 + '&preg9=' + preg9 + '&preg10=' + preg10 + '&preg11=' + preg11 + '&preg12=' + preg12 + '&preg13=' + preg13 + '&preg14=' + preg14 + '&preg15=' + preg15 + '&preg16=' + preg16 + '&preg17=' + preg17 + '&preg18=' + preg18 + '&preg19=' + preg19 + '&preg20=' + preg20 + '&preg21=' + preg21 + '&preg22=' + preg22 + '&preg23=' + preg23 + '&preg24=' + preg24 + '&preg25=' + preg25 + '&preg26=' + preg26 + '&preg27=' + preg27 + '&preg28=' + preg28 + '&preg29=' + preg29 + '&preg30=' + preg30 + '&preg31=' + preg31 + '&preg32=' + preg32 + '&id_instruct=' + id_instruct + '&opcion=agreaccion';

if (idcursoen == '' || !document.querySelector('input[name=preg1]:checked') || !document.querySelector('input[name=preg2]:checked') || !document.querySelector('input[name=preg3]:checked') || !document.querySelector('input[name=preg4]:checked') || !document.querySelector('input[name=preg5]:checked') || !document.querySelector('input[name=preg6]:checked') || !document.querySelector('input[name=preg7]:checked') || !document.querySelector('input[name=preg8]:checked') || !document.querySelector('input[name=preg9]:checked') || !document.querySelector('input[name=preg10]:checked') || !document.querySelector('input[name=preg11]:checked') || !document.querySelector('input[name=preg12]:checked') || !document.querySelector('input[name=preg13]:checked') || !document.querySelector('input[name=preg14]:checked') || !document.querySelector('input[name=preg15]:checked') || !document.querySelector('input[name=preg16]:checked') || !document.querySelector('input[name=preg17]:checked') || !document.querySelector('input[name=preg18]:checked') || !document.querySelector('input[name=preg19]:checked') || !document.querySelector('input[name=preg20]:checked') || !document.querySelector('input[name=preg21]:checked') || !document.querySelector('input[name=preg22]:checked') || !document.querySelector('input[name=preg23]:checked') || !document.querySelector('input[name=pregPEN2]:checked') || !document.querySelector('input[name=pregPEN]:checked') || !document.querySelector('input[name=pregPEN3]:checked') || preg27 == '' || preg28 == '' || !document.querySelector('input[name=pregPEN]:checked') || preg30 == ''|| !document.querySelector('input[name=pregPEN31]:checked') || !document.querySelector('input[name=preg28]:checked')) {
...
function agrPartc() {
    ...
    grupo = document.getElementById('grupociaac2').value;
    datos = 'idinsp=' + idinsp + '&acodigos=' + acodigos + '&gstIdlsc=' + gstIdlsc + '&idcord=' + idcord + '&idntrc=' + idntrc + '&finicio=' + finicio + '&finalf=' + finalf + '&hrcurs=' + hrcurs + '&sede=' + sede + '&modalidad=' + modalidad + '&link=' + link + '&contracur=' + contracur + '&classroom=' + classroom + '&grupo=' + grupo + '&opcion=participante';
//alert(datos);
...
function eliNsp(idcursop) {
    ...
    $("#eliminar-modal #idInspt").val(cursop[0]);

    if(cursop[1]==1){
    $("#participante").html('¿ESTÁ SEGURO DE ELIMINAR AL COORDINADOR/INSTRUCTOR?');
    $("#perfil").val('INSTRUCTOR');
    }else if(cursop[1]==2){
    $("#participante").html('¿ESTÁ SEGURO DE ELIMINAR AL COORDINADOR?');
    $("#perfil").val('CORD');        
    }else if(cursop[1]==3){
    $("#participante").html('¿ESTÁ SEGURO DE ELIMINAR AL INSTRUCTOR?');
    $("#perfil").val('INSTRUCTOR');        
    }else{
    $("#participante").html('¿ESTÁ SEGURO DE ELIMINAR AL PARTICIPANTE?');
    $("#perfil").val('PAR');                
    }
...
// codInsp = document.getElementById('codInsp').value;
    ...
    if (idInsp == '') {
        ...
        $.ajax({
            url: '../php/regCurso.php',
            type: 'POST',
            data: 'idInsp=' + idInsp + '&perfil='+ perfil + '&opcion=eliInsp'
        }).done(function(respuesta) {
...
//AGREGAR INSTRUCTOR
function agregarInstr(){
    //gstIdlsc = document.getElementById('gstIdlstc').value;    
    codigoCurso = document.getElementById('codigoCurso').value;
    idinstructor = document.getElementById('idinstinst').value;
    puesto = 'INSTRUCTOR';
    if(idinstructor!=''){
    $.ajax({
        url: '../php/regCurso.php',
        type: 'POST',
        data: 'codigoCurso=' + codigoCurso + '&idinstructor='+ idinstructor + '&puesto=' + puesto + '&opcion=agregraInstr'
    }).done(function(respuesta) {
...
function agregarCoord(){
    codigoCurso = document.getElementById('codigoCurso').value;
    idinstructor = document.getElementById('idicoordin').value;
    puesto = 'COORDINADOR';
    ...
    $.ajax({
        url: '../php/regCurso.php',
        type: 'POST',
        data: 'codigoCurso=' + codigoCurso + '&idinstructor='+ idinstructor + '&puesto=' + puesto + '&opcion=agregraCoord'
    }).done(function(respuesta) {
        ...
        if(respuesta==0){
            ...
            Swal.fire({
            type: 'info',
            title: 'FALTA DESIGNAR COORDINADOR',
            showConfirmButton: false,
            customClass: 'swal-wide',
            timer: 2000,
            backdrop: `
...
function inspeval(cursos) {
    ...
    let codigocur = document.getElementById('codigoIDCuro').value
//alert(codigocur);
$.ajax({
    url: '../php/conProgra.php',
    type: 'GET',
    data: 'codigocur=' + codigocur
}).done(function(resp) {
    obj = JSON.parse(resp);
    var res = obj.data;
    var x = 0;
...
//FUNCIÓN PARA EVALUAR MASIVAMENTE CURSO PROGRAMADO 
function evalresult() {
...
//ACTUALIZA LA TABLA DE CURSOS PROGRAMADOS
function updaviscurs() {
    $("#data-table-cursosProgramados").dataTable().fnDestroy();
    let id = document.getElementById('codigoIDCuro').value;
...
//CIERRA EL MODAL DE ASISTENCIA MASIVA
function closeasist() {
//alert("entro");
$('#modal-asitmasiva').modal('hide');
}

function closeeval() {
//alert("cerrar evaluacion");
$('#modal-evalua').modal('hide');
}
...
// $("#folioc").html(d[21]);
curso = 'FO' + cursos;
let id_codigo = document.getElementById('codigoIDCuro').value;
$.ajax({
    url: '../php/conInsp.php',
    type: 'GET',
...
//alert(cursos1);
$.ajax({
    url: '../php/asismasiv.php',
    type: 'GET',
    data: 'cursos1=' + cursos1
}).done(function(resp) {
    obj = JSON.parse(resp);
    var res = obj.data;
    var x = 0;
...
document.getElementById('grupoci').disabled = false;
}
...
document.getElementById('grupoci').disabled = true;
...
for (m = inicio; m <= final; m++) {
    ...
    html += '<table id="table1E" class="table table-striped table-bordered dataTable" style="width:100%" role="grid" aria-describedby="example_info"><thead><tr><td colspan="7" style="text-align:center;"><b>' + meses[m] + '</b></td></tr><tr><th><i></i>L</th><th><i></i>M</th><th><i></i>M</th><th><i></i>J</th><th><i></i>V</th><th><i></i>S</th><th><i></i>D</th></tr></thead><tbody>';
    for (i = 0; i < res.length; i++) {


        if (obj.data[i].habil == 'SI') {
            diasp = "<input type='checkbox' name='idiase' id='idiase' class='idiase' value='" + obj.data[i].numero + "' checked='checked'/>";
// html= "<input type='checkbox' style='width:17px; height:17px;' checked='true' name='infinal' id='infinal'/>"
} else {
    diasp = "<input type='checkbox' name='idiase' id='idiase' class='idiase' value='" + obj.data[i].numero + "'/>";
}
...
html += '</div></div></div>';
$("#edihabilDias").html(html);
})
}

$("#allselect").on("click", function() {
    $(".idiase").prop("checked", this.checked);
});
...
function validaDias() {
    ...
    dato = 'codigo=' + codigo + '&array1=' + array1 + '&hcurso=' + hcurso + '&hora_fin=' + hora_fin + '&modalidads=' + modalidads;
...
//ELEIMINAR FECHA DE CURSO 
function eliminarFecha(){

    var codigo = document.getElementById('codigo').value;

    datos = 'codigo=' + codigo + '&opcion=eliminarDiasPro';
...
html = '<div id="table2A" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"> <div class="col-sm-12">';
//CONTEO DEL MES, INICIO A FIN 
for (m = inicio; m <= final; m++) {
    x++;
...
function agregarDias() {
    ...
    codigo = document.getElementById('codigo').value;
// alert('&finicial=' + finicial + '&ffinal=' + ffinal + '&hora_ini=' + hora_ini + '&hora_fin=' + hora_fin + '&idPer=' + idPer + '&codigo=' + codigo + '&opcion=' + opcion);
var diasr = new Array();
/*AGRUPAMOS TODOS LOS DIAS INPUTS CON NAME=idias*/
$('input[name="idias"]').each(function (element) {
    var item = {};
...
datos = 'array1=' + array1 + '&array2=' + array2 + '&array3=' + array3 + '&finicial=' + finicial + '&ffinal=' + ffinal + '&hora_ini=' + hora_ini + '&hora_fin=' + hora_fin + '&idPer=' + idPer + '&codigo=' + codigo + '&opcion=' + opcion;
