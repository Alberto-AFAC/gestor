...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Gestión de inspección</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="./"><i class="fa fa-search"></i> <span>Busqueda</span></a></li>
        <li>
          <!--<a href="../widgets.html">-->
  ...
  <div class="content-wrapper">
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab">Inspector</a></li>
              <li><a href="#estudios" data-toggle="tab">Estudios</a></li>
              <li><a href="#timeline" data-toggle="tab">Curso</a></li>
              <li><a href="#settings" data-toggle="tab">Programación de curso </a></li>
            </ul>
    ...
    <form id="Dtall" class="form-horizontal" action="" method="POST" >
                  <input type="hidden" name="idinsp" id="idinsp" value="<?php echo $pector[0]?>">
                  <div class="form-group">
                    <div class="col-sm-4">
                    <label>Nombres</label>
                    <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo $pector[1]?>">
                    </div>

                     <div class="col-sm-4">
                      <label>Apellidos</label>
                      <input type="text" class="form-control" id="apellidos" name="apellidos" value="<?php echo $pector[2]?>">
                      </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="puesto" name="puesto">
                     ...
                     <div class="col-sm-6">
                      ...
                      <input type="email" class="form-control" id="unidad" name="unidad">
                      </div>
                  </div>                  
          ...
          <div class="col-sm-5">
          <button type="button" class="btn btn-default" onclick="registrar();">Submit</button>
          <!--<button type="button" class="btn btn-primary" onclick="editAra()">Guardar</button>-->
          </div>
          <b><p class="alert alert-danger text-center padding error" id="error">no se pudo guardar registro</p></b>
          <b><p class="alert alert-success text-center padding exito" id="exito">registro guardado</p></b>
...
<a style="color: blue" href='#' type='button' data-toggle='modal' data-target='#modalVal' style='width:100%'>BANNER</a>
...
<h4 class="modal-title" id="exampleModalLabel">Titulo </h4>  
            ...
            <div class="modal-body">
                ...
                <input type="hidden" id="opcion" name="opcion" value="actualizar">
                    ...
                    <button type="button" id="button" class="btn btn-green btn-lg" onclick="OK();">Aceptar</button>
                    </div>
