          ...
          <div class="col-xs-12 .col-md-0"  tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">ULTIMO GRADO DE ESTUDIOS</h4>
              </div>
  ...
  <!--<input type="text" onkeyup="mayus(this);" class="form-control" id="gstDocmt" name="gstDocmt">-->
                ...
                <button type="button" id="button" class="btn btn-info" onclick="agrStudio();">ACEPTAR</button>
          ...
          <div class="col-xs-12 .col-md-0"  tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
            ...
            <div class="modal-content">
              ...
              <form class="form-horizontal">
                <input type="text" class="form-control" id="AgstIDper" name="AgstIDper">
              ...
              <div class="form-group">
                  <div class="col-sm-5">
                    <button type="button" id="button" class="btn btn-info" onclick="agrProfsn();">ACEPTAR</button>
                  </div>
