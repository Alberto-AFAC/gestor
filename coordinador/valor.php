                        ...
                        <div class="form-group" id="buton" style="display: none;"><br>
                            <div class="col-sm-offset-0 col-sm-2">
                                <button type="button" id="button" title="Dar click para guardar los cambios"
                                    ...
                                    class="btn btn-block btn-primary" onclick="actDatos();">ACEPTAR</button>
                            </div>
                            <b>
            ...
            <div class="tab-pane" id="puesto">
                ...
                <form id="Pusto" class="form-horizontal" action="" method="POST">
                    ...
                    <p id="nompusto" style="display: none; cursor: pointer;"><a onclick="nompusto();"> EDITAR NOMBRE DEL
                            PUESTO<span class="text-red" style="font-size:20px">*</span> <i class="fa fa-edit"></i></a>
                    ...
                    <div class="form-group">
                        <div class="col-sm-6">
                            ...
                            <p id="oclOJT"><label>OJT </label> ADJUNTAR DOCUMENTO <a type="button"
                                    class="asiste btn btn-default" title="Subir documento" onclick="adjunojt('OJT');"
                                    data-toggle="modal" data-target="#modal-doc"><i
                        ...
                        <div class="col-sm-6">
                            <p id="oclBTC"><label>BITÁCORAS</label> ADJUNTAR DOCUMENTO <a type="button"
