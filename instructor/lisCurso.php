...
<div class="form-group">
        ...
        <div class="col-sm-3">
            <input type="radio" id="finalizado" name="filtrocur" value="finalizado">
            <label for="finalizado">COMPLETADOS</label><br>
            </div>

            <div class="col-sm-3">
              <input type="radio" id="programados" name="filtrocur" value="programados">
              <label for="programados">POR COMPLETAR</label><br>
              </div>

               <div class="col-sm-3">
                  <input type="radio" id="cancelados" name="filtrocur" value="cancelados">
                  <label for="cancelados">POR VENCERss</label><br>
              </div>
        </div>
        </div>
        </form>
