...
["<?php echo  $data['gstNmpld']?>","<?php echo  $data['gstNombr']?>","<?php echo $data['gstApell']?>","<?php echo $data['gstCatgr']?>","<?php 	if($antiguedad <=30){
                ...
                echo "<a type='button' title='Por evaluación' onclick='perfil({$gstIdper})' class='btn btn-warning'  data-toggle='modal' ><i class='fa ion-android-clipboard'></i> POR EVALUAR </a> <a href='javascript:openDtlls()' title='Perfil' onclick='perfil({$gstIdper})' class='datos btn btn-default'><i class='glyphicon glyphicon-user text-success'></i></a> ";

                    }else if($data['gstEvalu'] == 'SI') {
                echo "<a type='button' title='Evaluado' onclick='resultado({$result})' class='datos btn btn-success'  data-toggle='modal'><i class='fa ion-android-clipboard'></i> EVALUADO</a> <a href='javascript:openDtlls()' title='Perfil' onclick='perfil({$gstIdper})' class='datos btn btn-default'><i class='glyphicon glyphicon-user text-success'></i></a> ";
