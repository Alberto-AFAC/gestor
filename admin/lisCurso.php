                  ...
                  <div class="box-header with-border">
	                	<form action="" class="formulario1">
                              ...
                              <div class="form-group ">
                                    ...
                                    <div class="col-sm-8">      
                                        <input class="col-sm-2" type="text" name="idcursoen" id="idcursoen" style= "font-size:18px; background-color: #E5E7EC; border: 0; outline: none" disabled="">
                                    </div>
                                    <div class="col-sm-8">
                                        <label style="font-size:16px">NOMBRE DEL CURSO:</label>
                                    </div>
                                    <div class="col-sm-12">      
                                        <input class="col-sm-12" type="text" name="nomcursoen" id="nomcursoen" style= "font-size:18px; background-color: #E5E7EC; border: 0; outline: none" disabled="">
                                    </div>
                              </div>
                          </div>
                    </form>
                    ...
                    <div class="box-header with-border">
                      ...
                      <form class="form-horizontal">
                        <div class="box-body">
                          <div class="form-group">
                          <div class="col-sm-12">
                          <textarea class="col-sm-12"  name="comentarios" id="preg16" rows="5" cols="40" onkeyup="mayus(this);" style= "font-size: 18px; border-radius: 5px; background-color: #E5E7EC" placeholder ="ESCRIBE AQUÍ TUS COMENTARIOS"></textarea>
                    </div>
              </form>
            </div>
          </div>
