<?php include ("../../conexion/conexion.php");
      ...
      $sql = "SELECT gstIdlsc,gstPrfil,gstTitlo,gstVignc,gstIdlsc,gstTipo FROM listacursos WHERE estado = 0 ORDER BY gstIdlsc ASC";
    ...
    ?>
			...
			<option value="<?php echo $idcat[0].','.$idcat[1].','.$idcat[3].','.$idcat[4]?>"><?php echo $idcat[2].' &#10143; '.$idcat[5]?></option>
			<?php endwhile; ?>
