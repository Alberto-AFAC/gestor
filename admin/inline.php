...
var piechar = new Chart(document.getElementById("piechart-licencias"), {
    ...
    data: {
       <?php  while($data = mysqli_fetch_array($resultado)){ ?>
        labels: ["LICENCIAS","ESCUELAS","EXAMENES","CERTIFICACION","OPERACIONES","PELIGROSAS","VUELO"
        ],
        datasets: [{
            label: "LICENCIAS",
            backgroundColor: ["#FF6609","#FF8C47"],
            borderWidth: 0,
            data: ["<?php echo $data['LICENCIAS']?>","<?php echo $data['ESCUELAS']?>","<?php echo $data['EXAMENES']?>","<?php echo $data['CERTIFICACION']?>","<?php echo $data['OPERACIONES']?>","<?php echo $data['PELIGROSAS']?>","<?php echo $data['VUELO']?>"] 
        },
        {
            label: "LICENCIAS",
            backgroundColor: ["#FF6609","#FF8C47"],
