...
$resultado = mysqli_query($conexion, $query);
      ...
      ?>
            ...
            ["<?php echo $data['id_reac']?>", "<?php echo $data['gstNombr']." ".$data['gstApell']?>",
                ...
                "<a href='constancia.php?data=<?php echo base64_encode($data['id']) ?>&cod=<?php echo $data['codigo']?> '><center><img src='../dist/img/constancias.svg' width='30px;' alt='pdf'></center></a><span><center><span  data-toggle='modal' data-target='#correcionModal' onclick='perfil(<?php echo $id_curso?>)' class='btn-info badge'>REALIZAR CORRECIÓN</span></center>",
