...
<body>
    ...
    if($con['gstCntnc'] == 'CONSTANCIA1' && $conteoStr >= 100){
        ...
        al {$con['diafinal']} de {$con['mesfinales']} del {$con['ano']}, con una duración de {$con['gstDrcin']}.</span><br><br>";
        ...
        if($con['fcurso'] >= '2022-12-01'){ //MARTHA LEON GARCIA 
        echo"<div class='caja'>
        ...
        ";
    }else if($con['gstCntnc'] == 'CERTIFICADO'  && $conteoStr >= 100 && $con['comparativo']=='DIFERENTE' && $con['modalidad']<>'AUTOGESTIVO1'){
        echo "<div style='text-align: center;'>
        ...
        al {$con['diafinal']} de {$con['mesfinales']} del {$con['ano']}, con una duración de {$con['duracion']} hora(s).</span><br><br>";
    ...
    }else if($con['gstCntnc'] == 'CERTIFICADO' && $conteoStr <= 99 && $con['comparativo']=='DIFERENTE' && $con['modalidad']<>'AUTOGESTIVO1'){
        echo "
        <div style='text-align: center;'>
            ...
            <p class='nombre-grupo-Min'><span style='color:black;'>Grupo:</span>{$con['grupo']}</p>
            <span class='p-2' style='font-family: Montserrat-Light'>Impartido por el Centro Internacional de Adiestramiento de Aviación Civil, en el marco del Programa de Capacitación de la Autoridad Aeronáutica, del {$con['dia']} de {$con['mesnombre']} al {$con['diafinal']} de {$con['mesfinales']} del {$con['ano']}, con una duración de {$con['duracion']} hora(s).</span>";
    ...
    }else if($con['gstCntnc'] == 'DIPLOMA' && $conteoStr >= 100 && $con['comparativo']=='DIFERENTE' && $con['modalidad']<>'AUTOGESTIVO1'){
        echo "<div style='text-align: center;'>
        <p class='CIAAC' style='font-family: Montserrat-Light'>El Centro Internacional de Adiestramiento de Aviación Civil</p>
        <p class='' style='text-align:center;padding-top:-35px;font-size:30px'>Otorga la presente</p>
        ...
        al {$con['diafinal']} de {$con['mesfinales']} del {$con['ano']}, con una duración de {$con['duracion']} hora(s).</span><br>";
    ...
    }else if($con['gstCntnc'] == 'DIPLOMA' && $conteoStr <= 99 && $con['comparativo']=='DIFERENTE' && $con['modalidad']<>'AUTOGESTIVO1'){
        echo "<div style='text-align: center;'>
        <p class='CIAAC' style='font-family: Montserrat-Light'>El Centro Internacional de Adiestramiento de Aviación Civil</p>
        ...
        <p class='nombre-Curso-Min' style='padding-top:-36px;'>{$con['gstTitlo']}</p>
            <p class='nombre-grupo-Min'><span style='color:black;'>Grupo:</span>{$con['grupo']}</p>
            <span class='p-2' style='font-family: Montserrat-Light'>Impartido por el Centro Internacional de Adiestramiento de Aviación Civil, en el marco del Programa de Capacitación de la Autoridad Aeronáutica, del {$con['dia']} de {$con['mesnombre']} al {$con['diafinal']} de {$con['mesfinales']} del {$con['ano']}, con una duración de {$con['duracion']} hora(s).</span><br>";
        ...
        //----------------------------------DESDE AQUI IGUAL--------------------------------
    }else if($con['gstCntnc'] == 'CERTIFICADO'  && $conteoStr >= 100 && $con['comparativo']=='IGUAL' && $con['modalidad']<>'AUTOGESTIVO1'){
        echo "<div style='text-align: center;'>
        <p class='CIAAC' style='font-family: Montserrat-Light'>El Centro Internacional de Adiestramiento de Aviación Civil</p>
        <p class='' style='text-align:center;padding-top:-35px;font-size:30px'>Otorga la presente</p>
        <p style='padding-bottom: 0px;font-family: Montserrat;font-size:45px;padding-top:-35px;' class='titulo-certificado'><b>C E R T I F I C A D O</b></p>
        ...
        <p style='padding-top:-30px;' class='nombre-Constancia'>{$con['gstTitlo']}</p> 
        <p class='nombre-grupo-Min'style='padding-top:10px;'><span style='color:black;'>Grupo:</span>{$con['grupo']}</p>
        </p><span class='p-2' style='font-family: Montserrat-Light'>Impartido por el Centro Internacional de Adiestramiento de Aviación Civil, en el marco del Programa de Capacitación de la Autoridad Aeronáutica, el {$con['dia']} de {$con['mesnombre']} del {$con['ano']}, con una duración de {$con['duracion']} hora(s).</span><br><br>";
        if($con['fcurso'] <= '2022-11-30'){ //Jessica Berenice Castañeda Gutierrez
            echo"<div class='caja'>
            <p style='margin-bottom: -40px;' class='p-2'>Encargada del Despacho del CIAAC:</p></div>
            <center><img src='../dist/img/firmas/directora.jpg' style='margin-top:-10px; width:400px; position: absolute; right: 45%;'></center>
    ...
    }else if($con['gstCntnc'] == 'CERTIFICADO' && $conteoStr <= 99 && $con['comparativo']=='IGUAL' && $con['modalidad']<>'AUTOGESTIVO1'){
        echo "
        <div style='text-align: center;'>
            <p class='CIAAC' style='font-family: Montserrat-Light'>El Centro Internacional de Adiestramiento de Aviación Civil</p>
            <p class='' style='text-align:center;padding-top:-35px;font-size:30px'>Otorga el presente</p>
            ...
            <p class='nombre-Curso-Min' style='padding-top:-36px;'>{$con['gstTitlo']}</p>
            <p class='nombre-grupo-Min'><span style='color:black;'>Grupo:</span>{$con['grupo']}</p>
            <span class='p-2' style='font-family: Montserrat-Light'>Impartido por el Centro Internacional de Adiestramiento de Aviación Civil, en el marco del Programa de Capacitación de la Autoridad Aeronáutica, el {$con['dia']} de {$con['mesnombre']} del {$con['ano']}, con una duración de {$con['duracion']} hora(s).";
    ...
    }else if($con['gstCntnc'] == 'DIPLOMA' && $conteoStr >= 100 && $con['comparativo']=='IGUAL' && $con['modalidad']<>'AUTOGESTIVO1'){
        echo "<div style='text-align: center;'>
        <p class='CIAAC' style='font-family: Montserrat-Light'>El Centro Internacional de Adiestramiento de Aviación Civil</p>
        <p class='' style='text-align:center;padding-top:-35px;font-size:30px'>Otorga la presente</p>
        <p style='padding-bottom: 0px;font-family: Montserrat;font-size:45px;padding-top:-35px;' class='titulo-certificado'><b>R E C O N O C I M I E N T O</b></p>
        ...
        <p style='padding-top:-30px;' class='nombre-Constancia'>{$con['gstTitlo']}</p> 
        <p class='nombre-grupo-Min'style='padding-top:10px;'><span style='color:black;'>Grupo:</span>{$con['grupo']}</p>
        </p><span class='p-2' style='font-family: Montserrat-Light'>Impartido por el Centro Internacional de Adiestramiento de Aviación Civil, en el marco del Programa de Capacitación de la Autoridad Aeronáutica, el {$con['dia']} de {$con['mesnombre']} del {$con['ano']}, con una duración de {$con['duracion']} hora(s).</span><br>";
    ...
    }else if($con['gstCntnc'] == 'DIPLOMA' && $conteoStr <= 99 && $con['comparativo']=='IGUAL' && $con['modalidad']<>'AUTOGESTIVO1'){
        echo "<div style='text-align: center;'>
        <p class='CIAAC' style='font-family: Montserrat-Light'>El Centro Internacional de Adiestramiento de Aviación Civil</p>
        <p class='' style='text-align:center;padding-top:-33px;font-size:30px'>Otorga el presente</p>
        <p style='padding-bottom: 0px;font-family: Montserrat;font-size:45px;padding-top:-35px;' class='titulo-certificado'><b>R E C O N O C I M I E N T O</b></p>
        ...
        <p class='nombre-Curso-Min' style='padding-top:-36px;'>{$con['gstTitlo']}</p>
            <p class='nombre-grupo-Min'><span style='color:black;'>Grupo:</span>{$con['grupo']}</p>
            <span class='p-2' style='font-family: Montserrat-Light'>Impartido por el Centro Internacional de Adiestramiento de Aviación Civil, en el marco del Programa de Capacitación de la Autoridad Aeronáutica, el {$con['dia']} de {$con['mesnombre']} del {$con['ano']}, con una duración de {$con['duracion']} hora(s).</span><br>";
        ...
        //----------------------------------------AUTOGESTIVO-----------------------------------------------------------------------------
    }else if($con['gstCntnc'] == 'DIPLOMA'  && $conteoStr >= 100 && $con['comparativo']=='DIFERENTE' && $con['modalidad']== 'AUTOGESTIVO1'||$con['gstCntnc'] == 'DIPLOMA' && $conteoStr >= 100 && $con['modalidad']=='AUTOGESTIVO1' && $con['comparativo']=='IGUAL'){
        echo "<div style='text-align: center;'>
        <p class='CIAAC' style='font-family: Montserrat-Light'>El Centro Internacional de Adiestramiento de Aviación Civil</p>
        <p class='' style='text-align:center;padding-top:-35px;font-size:30px'>Otorga la presente</p>
        <p style='padding-bottom: 0px;font-family: Montserrat;font-size:45px;padding-top:-35px;' class='titulo-certificado'><b>R E C O N O C I M I E N T O</b></p>
        ...
        <p style='padding-top:-30px;' class='nombre-Constancia'>{$con['gstTitlo']}</p> 
        <p class='nombre-grupo-Min'style='padding-top:10px;'><span style='color:black;'>Grupo:</span>{$con['grupo']}</p>
        </p><span class='p-2' style='font-family: Montserrat-Light'>Impartido por el Centro Internacional de Adiestramiento de Aviación Civil, en el marco del Programa de Capacitación de la Autoridad Aeronáutica, en {$con['mesnombre']} del {$con['ano']}, con una duración de {$con['duracion']} hora(s).</span><br><br>";
       ...
       echo"<div class='caja'>
    ...
    }else if($con['gstCntnc'] == 'DIPLOMA'  && $conteoStr <= 99 && $con['comparativo']=='DIFERENTE' && $con['modalidad']== 'AUTOGESTIVO1'||$con['gstCntnc'] == 'DIPLOMA' && $conteoStr <= 99 && $con['modalidad']=='AUTOGESTIVO1' && $con['comparativo']=='IGUAL'){
        echo "
        <div style='text-align: center;'>
            <p class='CIAAC' style='font-family: Montserrat-Light'>El Centro Internacional de Adiestramiento de Aviación Civil</p>
            <p class='' style='text-align:center;padding-top:-35px;font-size:30px'>Otorga el presente</p>
            ...
            <p class='nombre-Curso-Min' style='padding-top:-36px;'>{$con['gstTitlo']}</p>
            <p class='nombre-grupo-Min'><span style='color:black;'>Grupo:</span>{$con['grupo']}</p>
            <span class='p-2' style='font-family: Montserrat-Light'>Impartido por el Centro Internacional de Adiestramiento de Aviación Civil, en el marco del Programa de Capacitación de la Autoridad Aeronáutica, en {$con['mesnombre']} del {$con['ano']}, con una duración de {$con['duracion']} hora(s).";
    ...
    }else if($con['gstCntnc'] == 'CERTIFICADO'  && $conteoStr >= 100 && $con['comparativo']=='DIFERENTE' && $con['modalidad']== 'AUTOGESTIVO1'||$con['gstCntnc'] == 'CERTIFICADO' && $conteoStr >= 100 && $con['modalidad']=='AUTOGESTIVO1' && $con['comparativo']=='IGUAL'){
        echo "<div style='text-align: center;'>
        <p class='CIAAC' style='font-family: Montserrat-Light'>El Centro Internacional de Adiestramiento de Aviación Civil</p>
        <p class='' style='text-align:center;padding-top:-35px;font-size:30px'>Otorga la presente</p>
        <p style='padding-bottom: 0px;font-family: Montserrat;font-size:45px;padding-top:-35px;' class='titulo-certificado'><b>C E R T I F I C A D O</b></p>
        ...
        <p style='padding-top:-30px;' class='nombre-Constancia'>{$con['gstTitlo']}</p> 
        <p class='nombre-grupo-Min'style='padding-top:10px;'><span style='color:black;'>Grupo:</span>{$con['grupo']}</p>
        </p><span class='p-2' style='font-family: Montserrat-Light'>Impartido por el Centro Internacional de Adiestramiento de Aviación Civil, en el marco del Programa de Capacitación de la Autoridad Aeronáutica, en {$con['mesnombre']} del {$con['ano']}, con una duración de {$con['duracion']} hora(s).</span><br>";
    ...
    }else if($con['gstCntnc'] == 'CERTIFICADO'  && $conteoStr <= 99 && $con['comparativo']=='DIFERENTE' && $con['modalidad']== 'AUTOGESTIVO1'||$con['gstCntnc'] == 'CERTIFICADO' && $conteoStr <= 99 && $con['modalidad']=='AUTOGESTIVO1' && $con['comparativo']=='IGUAL'){
        echo "<div style='text-align: center;'>
        <p class='CIAAC' style='font-family: Montserrat-Light'>El Centro Internacional de Adiestramiento de Aviación Civil</p>
        <p class='' style='text-align:center;padding-top:-33px;font-size:30px'>Otorga el presente</p>
        <p style='padding-bottom: 0px;font-family: Montserrat;font-size:45px;padding-top:-35px;' class='titulo-certificado'><b>C E R T I F I C A D O</b></p>
        ...
        <p class='nombre-Curso-Min' style='padding-top:-36px;'>{$con['gstTitlo']}</p>
            <p class='nombre-grupo-Min'><span style='color:black;'>Grupo:</span>{$con['grupo']}</p>
            <span class='p-2' style='font-family: Montserrat-Light'>Impartido por el Centro Internacional de Adiestramiento de Aviación Civil, en el marco del Programa de Capacitación de la Autoridad Aeronáutica, en {$con['mesnombre']} del {$con['ano']}, con una duración de {$con['duracion']} hora(s).</span><br>";
       
        if($con['fcurso'] <= '2022-11-30'){ //Jessica Berenice Castañeda Gutierrez 
        echo"<div style='margin-top:-4%' class='caja'>
        <p style='margin-bottom: -25px;' class='p-2'>Encargada del Despacho del CIAAC:</p></div>
            <center><img src='../dist/img/firmas/directora.jpg' style='margin-top:-10px; width:400px; position: absolute; right: 45%;'></center>
        </div>
        <div style='padding-top: 7px; text-align: center;'>
            ...
            <div class='column middle'>
                <br><br><br><br><br>
                <span style='font-size: 10px; font-weight: bold; color: #996633;padding-left: -50px;margin-top:-12px' class='p-2'>Secretaría de Infraestructura, Comunicaciones y Transportes - Agencia Federal de Aviación Civil– Centro Internacional de
                Adiestramiento de Aviación Civil / SCT-AFAC-CIAAC</span><br>
                <span style='font-family: Montserrat-Light;text-align:center' class='p-2';>Mtra. Jessica Berenice Castañeda Gutierrez</span><br>
            </div>
        </div>";
    ...
    <div class="p-3">
        ...
        <span class="fecha-emision" style="font-family: Montserrat-Light">Fecha de descarga: <?php echo $hoy ?> </span>
