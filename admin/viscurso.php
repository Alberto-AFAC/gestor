  ...
  <input type="text" style="text-transform:uppercase;" class="form-control disabled" id="gstTitlo" name="gstTitlo" disabled="">
                     ...
                     <div class="col-sm-4">
                      ...
                      <select type="text" class="form-control" id="gstTipo" name="gstTipo" disabled="">
  ...
  <input type="text" class="form-control disabled" id="gstDrcin" name="gstDrcin" disabled="">
                ...
                <div class="col-sm-offset-0 col-sm-4">
                         <label>PERIODO DE VIGENCIA</label>                         
                            <select type="text" class="form-control" id="gstVignc" name="gstVignc" disabled=""> 
  ...
  <input type="text" class="form-control" id="sede" name="sede" disabled="">
  </div>
  <div class="col-sm-4">
  <label>MODALIDAD</label>
  <select type="text" class="form-control" id="modalidads" name="modalidads" disabled="">
