                        ...
                        <!-- Add the bg color to the header using any of the bg-* classes -->
                            ...
                            <div class="box-footer no-padding">
                                <ul class="nav nav-stacked">
                                    <li><a href="#">INFORMACION PERSONAL <span class="pull-right badge bg-blue"></span></a></li>
                                    <li><a style="cursor: pointer;" onclick="perinsp();" data-toggle='modal' data-target='#modal-info'>DATOS DEL PUESTO <span class="pull-right badge bg-red"></span></a></li>
