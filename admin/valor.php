...
<table class="table table-striped table-hover">
  ...
  <tbody>
    <tr>
      ...
      <td><input type="text" disabled="" style="text-transform:uppercase;" class="form-control" id="gstFeing" name="gstFeing"></td>
      <td></td>
...
<!-- DISEÑO ANTIGUO/.col -->
<div style="padding-top: 24px;"class="col-md-12">
    <div class="nav-tabs-custom">
...
<div id="select1"></div> 
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            ...
                            <select style="width: 100%" class="form-control" class="selectpicker" name="gstespecialidad"
                                disabled="" id="gstespecialidad" type="text" data-live-search="true">
