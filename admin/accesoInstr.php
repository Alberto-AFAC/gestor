    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content" id="lista">
                                            ...
                                            <form id="personal-ext" class="form-horizontal" action="" method="POST">
                                                <div class="form-group">
                                                    <div class="col-sm-4">
                                                        ...
                                                        <select id="idperson" name="idperson" class="form-control" data-placeholder="SELECCIONE A LA PERSONA">
                                                        ...
                                                        <div class="destino col-sm-4">
                                                            ...
                                                            <select type="text" class="form-control inputalta" id="cargos" name="cargos">
                                                                <option value="" selected>ELEGIR UNA OPCIÓN</option>
                                                                <option value="INSTRUCTOR">INSTRUCTOR</option>
                                                                <option value="COORDINADOR">COORDINADOR</option>
                                                                <option value="COORDINADOR_A">COORDINADOR A</option>
                                                            </select>
                                                        </div>
                                                        <div class="col-sm-4">
                ...
                Todos los derechos Reservados DDE .</footer>
                        ...
                        <form class="form-horizontal" id="Forstd">
                            ...
                            <div class="form-group">
                                <div class="col-sm-5">
                                    <button type="button" title="AGREGAR PERSONA EXTERNA"
                                    class="btn btn-block btn-primary botonnet"
                                    onclick="deleteAcceso()"><a style="color: #fff;"
            ...
            <div class="modal-dialog width" role="document" style="/*margin-top: 7em;*/">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form class="form-horizontal" id="Forstd">
                                <input type="hidden" class="form-control disabled inputalta" name="idpersona" id="idpersona" value="" >
                                <div class="form-group">
                                    <div class="col-sm-8">    
                                        <label class="label2">NOMBRE(S)</label>
                                        <input type="" class="form-control disabled inputalta" name="gstnomebres" id="gstnomebres" disabled="">
                                    </div>
                                    <div class="destino col-sm-4">
                                        <label class="label2">*CARGO</label>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-5">
                                        <button type="button" title="AGREGAR PERSONA EXTERNA"
                                        class="btn btn-block btn-primary botonnet"
                                        onclick="updateAcceso()"><a style="color: #fff;"
                                        data-toggle="tab">ACEPTAR</a></button>
                                    </div>
                                </div>
                                <br>
    ...
    if (obj.data[R].gstIdper == gstIdper) {
        ...
        function deleteAcceso(){
            ...
            $.ajax({
                url: '../php/insertInstr.php',
                type: 'POST',
                data: 'insperco='+insperco+'&cargoacceso='+cargoacceso+'&cargoinsco='+cargoinsco+'&opcion=eliminar'
            }).done(function(respuesta) {
                if(respuesta==0){
                    Swal.fire({
                        type: 'success',
