  ...
  <li><a href="#timeline" data-toggle="tab">LISTA DE PROGRAMACIÓN</a></li>
                                      ...
                                      <div class="post">
                                          ...
                                          <form class="form-horizontal">
                                              ...
                                              <div class="form-group" id="visFec" style="display: none;">
                                                  <div class="col-sm-4">
                                                      ...
                                                      <button type="button" style="font-size:16px"
                                                          class="btn btn-default" onclick="reiFec();">REINICIE
                                                          FECHAS</button>
                                                  </div>
                                              </div>
                                              ...
                                              <div class="form-group" id="mosFec">
                                                  <div class="col-sm-4">
                                                      <label class="label2">FECHA INICIO <span class="fa fa-lightbulb-o"
                                                              style="display: none;color:red;" id="av"></label>
                                                      <input type="date" class="form-control inputalta" id="fcurso"
                                                          name="fcurso">
                                                  </div>

                                                  <div class="col-sm-4">
                                                      <label class="label2">FECHA CONCLUSIÓN <span
                                                              class="fa fa-lightbulb-o" style="display: none;color:red;"
                                                              id="so"></label>
                                                      <input type="date" class="form-control inputalta" id="fechaf"
                                                          name="fechaf">
                                                  </div>

                                                  <div class="col-sm-4">
                                                      <label class="label2">HORA</label>
                                                      <a type='button' title='Días Hábiles' onclick='hrsDias()'
                                                          class='btn btn-info' data-toggle='modal'
                                                          data-target='#modal-diahabil' id="modalMost">DÍAS HÁBILES </a>
                                                      <a type='button' title='Días Hábiles' onclick='hrsDiasAct()'
                                                          class='btn btn-info' data-toggle='modal'
                                                          data-target='#modal-diahabil' id="modalOcul"
                                                          style="display: none;">DÍAS HÁBILES </a>
                                                  </div>
                                              </div>
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-sm-4">
                                                      ...
                                                      <select class="form-control inputalta" id="idcord" name="idcord"
                                                          style="width: 100%;">
                                                  ...
                                                  <div class="col-sm-4">
                                                      ...
                                                      <select style="width: 100%" class="form-control inputalta"
                                                          class="selectpicker" id="idinst" name="idinst[]" type="text"
               ...
               if($instructors[3]==2){
                ...
                $estado = "";
                                                  ...
                                                  <div class="col-sm-4" id="camsede" name="camsede">
                                                      <label class="label2">SEDE DEL CURSO</label>
                                                      <input type="text" onkeyup="mayus(this);"
                                                          class="form-control inputalta" id="sede" name="sede">
                                                  </div>
                                              </div>
                                              ...
                                              <div class="form-group"><br>
                                                  <div class="col-sm-offset-0 col-sm-5">
                                                      ...
                                                      <button type="button" id="vaciar" class="btn btn-default"
