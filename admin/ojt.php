                                    ...
                                    <div class="post">
                                        ...
                                        <form id="addcurse" class="form-horizontal" action="" method="POST">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    <label>NIVEL</label>
                                                    <select type="text" class="form-control" id="nivel"
                                                        name="nivel">
                                                ...
                                                <div class="col-md-4">
                                                    <label>TAREA</label>
                                                   <input type="text" class="form-control" placeholder="Ingresa tarea..." name="tarea" id="tarea">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label>SUBTAREA</label>
                                                   <input type="text" class="form-control" placeholder="Ingresa subtarea..." name="subtarea" id="subtarea">
                                                </div>
                                                <div class="col-sm-3">
                                                <label>SUB-SUBTAREA</label>
                                                   <input type="text" class="form-control" placeholder="Ingresa subtarea..." name="subsubtarea" id="subsubtarea">
                                                </div>
