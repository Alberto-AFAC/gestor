...
if($data["ojt_subtarea"] == 0 && $data["numsubt"] == 1){
  $sub1 = "";

}else{
  $sub1 = "<a href='#' data-toggle='modal' data-target='#detalleSub1' onclick='idsub1($id)' >SUB 1 |</a>";
...
if($data["ojt_subtarea"] == 0 && $data["numsubt"] == 1){
  ...
  $sub2 = "<a href='#' data-toggle='modal' data-target='#detalleSub2' onclick='idsub2($id)' >SUB 2 |</a>";

}

if($data["ojt_subtarea"] == 0){
  $sub3 = "";

}else{
  $sub3 = "<a href='#' data-toggle='modal' data-target='#detalleSub3' onclick='idsub3($id)' >SUB 3 |</a>";
...
?>
        ...
        ["<?php echo  $contador;?>", "<?php echo  $data['gstCatgr']?>",
            ...
            "<?php echo $sub1?> <?php echo $sub2?> <?php echo $sub3?>",
        ],
