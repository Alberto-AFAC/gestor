...
ORDER BY
    ...
    $prueba2 = mysqli_fetch_assoc($resultado2);
        ...
        $mail->CharSet = 'UTF-8';
            ...
            <br >        
            <div style='position: absolute; width: 98%; height: 140px; background: #93291e; background: -webkit-linear-gradient(to right, #c90d23, #c90d23);background: linear-gradient(to right, #93291e, #c90d23);'>
                <br><b><label style='font-size:25px; font-family:Montserrat; color:#FEFDFD;  margin-left: 40%;float:none;' for=''>PROGRAMACIÓN</label></b>
                <b><label style='font-size:25px; font-family:Montserrat; color:#FEFDFD;  margin-left: 28%;float:none;' for=''>ENTRENAMIENTO EN EL PUESTO DE TRABAJO</label></b>
                <b><label style='font-size:25px; font-family:Montserrat; color:#FEFDFD;  margin-left: 47%;float:none;' for=''>OJT</label></b>
            </div>
            <br><br><br><br><br><br><br><br>
            <!-- COMISION -->
            <div style='margin-left: 80px; font-size:18px; font-family:Montserrat'>
            ...
            <div style='margin-left: 40%; font-size:18px; font-family:Montserrat'>
                <a  align='center' href='https://afac-avciv.com/'>CONFIRMAR ASISTENCIA</a>
            </div><br>
            <div style='margin-left: 39%; font-size:18px; font-family:Montserrat'>
