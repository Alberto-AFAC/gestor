...
<a href='javascript:closeDtlls()'><i class='fa fa-times'></i></a>
            ...
            <ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab">ALTA DE PERSONAL</a></li>
              <li><a href="#estudios" data-toggle="tab">HISTORIAL ACAEMICO</a></li>
          ...
          <form id="Dtall" class="form-horizontal" action="" method="POST" >
            <div class="form-group">
                <div class="col-sm-4">
                    <H3>
                     <label> DATOS PERSONALES </label></H3>
                </div>
            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                       <label>CURP</label>
                       <input type="tex" onkeyup="mayus(this);" class="form-control" id="gstCurp" name="gstCurp">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-4">
                       <label>RFC</label>
                       <input type="tex" onkeyup="mayus(this);" class="form-control" id="gstRfc" name="gstRfc">
                    </div>
                ...
                <div class="form-group">
                    <div class="col-sm-4">
                       ...
                       <input type="number" onkeyup="mayus(this);" class="form-control" id="gstCpstl" name="gstCpstl">
                    </div>
                ...
                <div class="form-group">
                    <div class="col-sm-4">
                       <label>CASA</label>
                       <input type="tel" onkeyup="mayus(this);" class="form-control" id="gstCasa" name="gstCasa">
                    </div>                    
                    <div class="col-sm-4">
                       <label>CELULAR</label>
                       <input type="text" onkeyup="mayus(this);" class="form-control" id="gstClulr" name="gstClulr">
                    </div>
                ...
                <div class="form-group">
                    <div class="col-sm-4">
                      <H3>
                        <label> DATOS DEL PUESTO </label></H3>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <!--<div class="col-sm-4">
                       ...
                       <select style="width: 100%" class="form-control" class="selectpicker" name="gstIDSub" id="gstIDSub" type="text" data-live-search="true">
                         <option value="">SELECCIONA LA SUB CATEGORÍA</option>
                         <?php //while($idsub2 = mysqli_fetch_row($sub2)):?>                      
                         <option value="<?php// echo $idsub2[0]?>"><?php //echo $idsub2[1];?></option>
                         <?php //endwhile; ?>
                       </select>
                    </div>-->

                    <!--<div class="col-sm-4" id="0">
                       <label>SUB CATEGORIA</label>
                       <select style="width: 100%" class="form-control" class="selectpicker" name="gstIDSub" id="gstIDSub" type="text" data-live-search="true">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-offset-0 col-sm-12">
                        <label style="color: white">.</label>
                      <select style="width: 100%" class="form-control" class="selectpicker" name="gstUbtrb" id="gstUbtrb" type="text" data-live-search="true">
                      <option value="">SELECIONE UBICACION DE TRABAJO</option>
        ...
        if(opt=="6"){
            ...
            $('#0').show();
                    ...
                    <div class="col-sm-6" style="display: none;">
                       ...
                       <input type="text" class="form-control" id="gstIDSubD" name="gstIDSub" value="0">
                    </div>
                </div>
...
<!---------------------12354568789---------------------->
              ...
              <div class="form-group">
                  <div class="col-sm-6">
                    <label>PUESTO</label>
                      <input type="text" onkeyup="mayus(this);" class="form-control" id="puesto" name="puesto">
                  </div>

                  <div class="col-sm-6">
                       <label>EMPRESA</label>
                       <input type="text" onkeyup="mayus(this);" class="form-control" id="empresa" name="empresa">
                  </div>
              </div>
              ...
              <div class="form-group">
                  <div class="col-sm-12">
                     ...
                     <textarea name="ACTIVIDADES" id="ACTIVIDADES"  placeholder="BREVE DESCRIPCIÓN DE LAS FUNCIONES DESEMPEÑADAS" onkeyup="mayus(this);" class="form-control" rows="5" cols="50"></textarea>
                  </div>
              </div>
            ...
            <div class="form-group">
                  <div class="col-sm-6">
                    <label>NOMBRE DE LA INSTITUCIÓN</label>
                      <input type="text" onkeyup="mayus(this);" class="form-control" id="institucion" name="institucion">
                  </div>

                  <div class="col-sm-6">
                       <label>CUIDAD</label>
                       <input type="text" onkeyup="mayus(this);" class="form-control" id="cuidadh" name="cuidadh">
                  </div>
            </div>
            ...
            <div class="form-group">
                  <div class="col-sm-6">
                       <label>PERIODO</label>
                       <input type="text" onkeyup="mayus(this);" class="form-control" id="periodo" name="periodo">
                  </div>

                  <div class="col-sm-6">
                      <label>DOCUMENTO</label>
                      <input type="text" onkeyup="mayus(this);" class="form-control" id="documento" name="documento">
              
                  </div>
                  </div>
              <div class="form-group">
                  <div class="col-sm-5">
                    <button type="button2" id="button2" class="btn btn-info btn-lg">Aceptar</button>
                  </div>
                    <b><p class="alert alert-danger text-center padding error" id="danger">Error al agregar datos </p></b>
                    <b><p class="alert alert-success text-center padding exito" id="succe">¡Se agregaron los datos con éxito!</p></b>
                    <b><p class="alert alert-warning text-center padding aviso" id="empty">Es necesario agregar los datos que se solicitan </p></b>
