	...
	if(!$resultado){
		...
		while($data = mysqli_fetch_assoc($resultado)){
		    ...
		    if($data['confirojt']== 'PENDIENTE'){
		        ...
		        $notificar = "<a title='Información de la programación' onclick='ojtprogram($id_registro)' class='datos btn btn-default' data-toggle='modal' data-target='#modal-proojt'><i class='fa fa-info'></i></a> <a title='Notificar' onclick='enviarMailOjt({$id_registro}.{$id})' class='datos btn btn-default' data-toggle='modal' data-target='#notificarConv'><i class='glyphicon glyphicon-send'></i></a> <a type='button' id='ev' title='Evaluación' onclick='evalun3($id_registro)' class='btn btn-default' data-toggle='modal' data-target='#modal-evaluarojtIII'><i class='fa ion-clipboard' style='font-size:15px;'></i></a>";
			...
			if($data['estatus'] == "PENDIENTE"){
				...
				$notificar = "<a title='Información de la programación' onclick='ojtprogram($id_registro)' class='datos btn btn-default' data-toggle='modal' data-target='#modal-proojt'><i class='fa fa-info'></i></a> <a title='Notificar' onclick='enviarMailOjt({$id_registro}.{$id})' class='datos btn btn-default'><i class='glyphicon glyphicon-send'></i></a> <a class='datos btn btn-default' data-toggle='modal' data-target='#modal-evaluarojt' class='datos btn btn-default' ><i class='fa ion-clipboard'></i></a>";
