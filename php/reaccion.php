...
if($opcion === 'agreaccion'){
	...
	if(reaccion($idcurso,$fechareac,$preg1,$preg2,$preg3,$preg4,$preg5,$preg6,$preg7,$preg8,$preg9,$preg10,$preg11,$preg12,$preg13,$preg14,$preg15,$preg16,$preg17,$preg18,$preg19,$preg20,$preg21,$preg22,$preg23,$preg24,$preg25,$preg26,$preg27,$preg28,$preg29,$preg30,$preg31,$preg32,$id_instruct,$conexion)){
		echo "0";
...
//FUNCION PARA REGISTAR EVALUACIÓN DE REACCIÓN OJT
...
//FUNCIÓN PARA COMPROBAR REACCIÓN DE CURSO
...
//FUNCIÓN PARA COMPROBAR REACCIÓN OJT
...
//FUNCIÓN PARA GUARDAR EL HISTORIAL DE REGISTRO OJT
...
function reaccion($idcurso,$fechareac,$preg1,$preg2,$preg3,$preg4,$preg5,$preg6,$preg7,$preg8,$preg9,$preg10,$preg11,$preg12,$preg13,$preg14,$preg15,$preg16,$preg17,$preg18,$preg19,$preg20,$preg21,$preg22,$preg23,$preg24,$preg25,$preg26,$preg27,$preg28,$preg29,$preg30,$preg31,$preg32,$id_instruct,$conexion){
	$query="INSERT INTO reaccion VALUES(0,'$idcurso','$fechareac','$preg1','$preg2','$preg3','$preg4','$preg5','$preg6','$preg7','$preg8','$preg9','$preg10','$preg11','$preg12','$preg13','$preg14','$preg15','$preg16','$preg17','$preg18','$preg19','$preg20','$preg21','$preg22','$preg23','$preg24','$preg25','$preg26','$preg27','$preg28','$preg29','$preg30','$preg31','$preg32','$id_instruct',0)";
	if(mysqli_query($conexion,$query)){
		return true;
	}else{
		return false;
...
//FUNCIÓN PARA REGISTRAR LA EVALUACIÓN DE REACCIÓN OJT
