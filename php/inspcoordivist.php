...
ORDER BY
	...
	if(!$resultado){
		...
		while($data = mysqli_fetch_assoc($resultado)){
			...
			$total =  "<a href='javascript:openDtlls()' title='Perfil' onclick='inspector({$gstIdper})' class='datos btn btn-default'><i class='glyphicon glyphicon-user text-success'></i></a>";
			/*if($data['gstEvalu'] == 'NO'){
	    ...
	    $caledario[] = [$data["gstNmpld"],$data["gstNombr"],$data["gstApell"],$categoria, $cursor, $total];
	}
}
