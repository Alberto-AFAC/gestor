...
<div class="card-body">
<h4 class="card-title"><?php echo $datos2['gstTitlo']?></h4>
...
<!-- <div class="col-md-3 col-sm-6">
<div class="card" style="width: 18rem;">
<img class="card-img-top img-responsive" src="https://globalindustries.mx/wp-content/uploads/2019/12/sct.jpg" alt="Measure">
<div class="card-body">
<h4 class="card-title">TITULO DEL CURSO</h4>
<p class="card-text">Descripción del curso</p>
<a href="#" class="btn btn-primary">APRENDER MÁS</a>
</div>
</div>
...
<div class="col-md-3 col-sm-6">
<div class="card" style="width: 18rem;">
<img class="card-img-top img-responsive" src="https://globalindustries.mx/wp-content/uploads/2019/12/sct.jpg" alt="Tracking &amp; Kerning">
<div class="card-body">
<h4 class="card-title">TITULO DEL CURSO</h4>
<p class="card-text">Descripción del curso</p>
<a href="#" class="btn btn-primary">APRENDER MÁS</a>
...
<div class="col-md-3 col-sm-6">
<div class="card" style="width: 18rem;">
<img class="card-img-top img-responsive" src="https://globalindustries.mx/wp-content/uploads/2019/12/sct.jpg" alt="Sans &amp; Sans-Serif">
<div class="card-body">
<h4 class="card-title">TITULO DEL CURSO</h4>
<p class="card-text">Descripción del curso</p>
<a href="#" class="btn btn-primary">APRENDER MÁS</a>
