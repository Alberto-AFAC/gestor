...
<a type="button" style="float: right; cursor: pointer;" onclick="cambio();">NO ENCUENTRA EL CURSO</a>
...
<!--         <button type="button" style="float: right;" onclick="cambio()">OTRO(S)</button>     -->
    ...
    id="nameOther" name="nameOther" placeholder="Ingrse otro nombre">
    </p>
    ...
    id="exito">¡Se registraron los datos y archivo
    con éxito!</p>
    </b>

    <b>
    <p class="alert alert-warning text-center padding aviso"
    id="vacio">Es necesario agregar los datos que se
    solicitan </p>
    </b>
    ...
    *
    ...
    ["<?php echo $x?>", "<?php echo $fecs[6]?>", "<?php echo $datas['tCurse']?>", "<?php echo $datas['inicio']?>",
    "<?php echo $datas['final']?>", "<?php echo $conf?>","<div style='cursor:pointer; width:100%; text-align:center; color: white; background-color: silver;'>  <p style='color:red;float:left; '></p><?php echo $pro?></div>"],
    ...
    ["<?php echo $x?>", "<?php echo $fecs[6]?>", "<?php echo $datas['tCurse']?>", "<?php echo $datas['inicio']?>",
    "<?php echo $datas['final']?>", "<?php echo $conf?>","<div style='cursor:pointer; width:100%; text-align:center; color: white; background-color: #398439;'>  <p style='color:red;float:left; '></p><?php echo $pro?></div>"],
    ...
    ["<?php echo $x?>", "<?php echo $fecs[6]?>", "<?php echo $datas['tCurse']?>", "<?php echo $datas['inicio']?>",
    "<?php echo $datas['final']?>", "<?php echo $conf?>","<div style='cursor:pointer; width:100%; text-align:center; color: white; background-color: #D58512;'>  <p style='color:red;float:left; '></p><?php echo $pro?></div>"],
