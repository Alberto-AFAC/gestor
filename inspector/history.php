...
<input type="hidden" name="nEmpl" id="nEmpl" value="<?php echo $datos[4]?>">
...
<input id="fileDoc" type="file" name="fileDoc" style="width: 410px; margin:0 auto; " required accept=".pdf,.doc" class="input-file" size="1450">
