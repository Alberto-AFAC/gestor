<?php
	...
	$query = "SELECT *,COUNT(*) as prtcpnts FROM cursos INNER JOIN listacursos ON listacursos.gstIdlsc = cursos.idmstr WHERE idinsp = '$id' AND cursos.estado = 0 GROUP by cursos.idmstr,cursos.idinst ORDER BY id_curso DESC";
